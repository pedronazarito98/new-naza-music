      ...
      <div>
        ...
        >
          ...
          <span>
            ...
            <a href="https://www.youtube.com/channel/UCAZa5Z2e2-8Z6LqOTskr-Qw" target="blank">
              Fonseec
            </a>
            </p>
    ...
    <div className="ModalStyle PaperModal">
      <div>
        ...
        >
          <span>
            Ouça agora no: 
            <a href="https://open.spotify.com/album/7nFGfq8ABRKwWVPqGH8K0y" target="blank">
               Spotify
            </a>
            <br/>
          </span>
          ...
          <span>
            ...
            <a href="https://www.youtube.com/channel/UCmBuLev4dz6NUi1L00hnkiA" target="blank">
              Hans Landim
            </a>
          </span>
        </Modals>
    ...
    <div className="ModalStyle PaperModal">
      <div>
        ...
        >
          <span>
            Ouça agora no:
            <a href="https://open.spotify.com/artist/5wssa01tJKQnuhgt3AfSXM" target="blank">
              Spotify
            </a>
            <br/>
          </span>
          ...
          <span>
            Inscreva-se no canal do YouTube:
            <a href="https://www.youtube.com/channel/UCWT4E1Of-TjgucLPZbe4FJg" target="blank">
            Dr. Hausen &#38; Mr. Guay
            </a>
          </span>
        </Modals>
  ...
  const body5 = (
    <div className="ModalStyle PaperModal">
      <div>
        ...
        >
          <p> <b>O segundo volume de Cada Um é o Mundo está em fase de produção</b>. </p>
          <span>
    ...
    <div className="ModalStyle PaperModal">
      <div>
        ...
        >
          <span>
            Ouça agora no: 
            <a href="https://www.youtube.com/watch?v=Vq5qK5HXmSg&list=OLAK5uy_kckn7el6lu3phIVxTD4xaw4rSR2T_fNoQ" target="blank">
              YouTube
            </a>
            <br/>
          </span>
          ...
          <span>
            Inscreva-se no canal do YouTube:
            <a href="https://www.youtube.com/user/lutoledooficial">
              Lu Toledo
            </a>
          </span>
        </Modals>
